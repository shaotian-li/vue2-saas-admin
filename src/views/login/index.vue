		...
		<div class="login-weaper">
			<div class="login-left">
				...
				<div class="login-left-box">
					<div>
						<div class="logo">{{ themeConfig.themeConfig.globalViceTitle }}</div>
						<h2 class="title">{{ themeConfig.themeConfig.globalViceDes }}</h2>
						<div class="msg">
			...
			<div class="login-right">
				<div class="login-main">
					<h4 class="login-title">{{ themeConfig.themeConfig.globalTitle }}</h4>
							...
							<div class="el-row" span="24">
								...
								<div class="el-col el-col-8">
									<div class="login-code">
										<div class="login-code-img">1234</div>
									</div>
								</div>
							</div>
						</el-form-item>
